    ...
    <div className="relative rounded-lg  cursor-pointer overflow-hidden group h-[35rem] w-[26rem]">
      ...
      <div className="relative overflow-hidden p-2 ">
        <Image
          ...
          height={362}
          alt="latest products"
          className="w-full h-auto object-cover group-hover:scale-125 group-hover:transition-all duration-500"
        />
      ...
      <div
        className={`h-0 opacity-0 group-hover:opacity-100 group-hover:h-40  p-5 text-center  flex-col duration-500 gap-1 bg-gray-200`}
      >

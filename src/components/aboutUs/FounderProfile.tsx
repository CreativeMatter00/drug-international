			...
			<div>
				...
				<div className="p-8 bg-primaryShade relative mb-10 rounded-md">
					<p className="font-medium text-lg text-white mb-10">
						Dr. M. M. Amjad Hussain was born on October 1st 1925 in the village
						of Enayetpur, District of Sirajganj. He had obtained his MBBS from
						Calcutta Medical College, India in 1948. He was the Founding
						Managing Director and Chairman of the following industries /
				...
				<div className="font-medium text-lg text-textPrimary">
					...
					was involved in trading. After denationalization, he became the
					managing director of both the textile and jute mills until November
					1991.
					<br />
					<br />
					Dr. M. M. Amjad Hussain was also the former chairman of the Bangladesh
					Textile Mills Association. In 1980, he started a pharmaceutical
					company called “Drug International Limited” which became one of the
					leading pharmaceutical companies in the country. The company expanded
					its activities by setting up a second unit under the name “Drug
					...
					<br />
					<br />
					In 1998, ATI Limited was established as a software development house.
					It is now one of the largest software firms in the country. ATI
					Limited has an educational and training division for the development
					and enhancement of employee skills and knowledge in the field of
					computer science.
					<br />
					<br />
					...
					mother’s name in 1956. “Meher-Un-Nessa Girls High School” at
					Enayetpur, Sirajganj was the only girls’ school in the vicinity at the
					time.
					<br />
					<br />
					“Drug International Ltd. (Herbal Division)” was founded with a vision
					to bring herbal remedies to society in a contemporary form and to
					unravel the mysteries behind the 5,000 year old science of natural
					medicine. This involved referring to ancient herbal texts, selecting
					indigenous herbs and subjecting the formulations to modern
					pharmacological, toxicological and safety tests to create new drugs
					and therapies. Since it’s inception, the company has focused on
					developing safe, natural and innovative remedies that will help people
					lead richer, healthier lives. Drug International Limited (Herbal
					Division) is now registered with the USFDA.
				</div>
			</div>
		</motion.div>
	);

	...
	return (
		<footer className="rounded-t-xl w-full py-16 max-lg:py-8 flex justify-center bottom-0 bg-[#6F0000]">
			<div className="container mx-auto flex items-center justify-center h-full flex-col text-white px-4 max-w-[1024px]">
				...
				<div className="flex gap-14 my-16 max-lg:gap-10 max-lg:mt-6 max-lg:mb-12 max-lg:flex-col">
              ...
              management and have diversified into multiple industries. */}
					...
					<div className="basis-2/12">
						...
						<div className="flex flex-col uppercase text-base font-medium gap-2">
							<Link href={`/${locale}/security-check`}>
					...
					<div className="basis-5/12 flex flex-col gap-2">
						<p className="uppercase text-lg font-medium underline">
							{/* Contact */}
							{t("contact")}
						</p>
						<div className="inline-flex gap-2">
							...
							<div className="flex flex-col uppercase text-base font-medium gap-1">
								<Link href="tel:+8802223362613-4">(+880) 2 223362613-4</Link>
								<Link href="tel:+8802223362621">(+880) 2 223362621</Link>
								<Link href="tel:+8802223370257">(+880) 2 223370257</Link>
							</div>
						</div>
						...
						<div className="inline-flex gap-2">
							...
							<Link
								href="mailto:info@drug-international.com"
								className="flex flex-col uppercase text-base font-medium gap-2"
							>
						...
						<div className="inline-flex gap-2">
							...
							<Link
								href="https://maps.app.goo.gl/j5QbFKadmPVaNgfh6"
								target="_blank"
								className="flex flex-col uppercase text-base font-medium "
							>

...
const Footer = () => {
  ...
  return (
    <footer
      className="rounded-t-xl w-full py-16 flex justify-center bottom-0"
      style={{
        background: "linear-gradient(115deg, #272727 60%, #5B5B5B 40%)",
      }}
    >
      <div className="container mx-auto flex items-center justify-center h-full flex-col text-white px-2">
        <div className="">
          <Image

				...
				<div className="container mx-auto w-full h-full font-medium">
					<div className="relative wrap overflow-hidden p-10 h-full">
						...
						<div className="mb-8 flex justify-center gap-4 items-center w-full right-timeline">
							...
							<div className="order-1 bg-white rounded-lg border border-[#E4E4E6] primaryShadow w-5/12 px-6 py-4">
								<h3 className="mb-4 text-textPrimary text-2xl uppercase">
									Company Inception
								</h3>
								<p className="text-sm text-textSecondary">
									Drug International Limited was founded in 1974, marking the
									beginning of a journey dedicated to pharmaceutical excellence.
									The company was incorporated under the Registrar of Joint
									Stock Companies as a Private Limited Company.
								</p>
							</div>
						</div>
						...
						<div className="mb-8 flex justify-center gap-4 flex-row-reverse items-center w-full left-timeline">
							...
							<div className="order-1 bg-white rounded-lg border border-[#E4E4E6] primaryShadow w-5/12 px-6 py-4">
								...
								<p className="text-sm text-textSecondary">
									Drug International Limited embarked on the formulation and
									production journey in 1980, laying the groundwork for becoming
									a pioneer in pharmaceutical manufacturing in Bangladesh.
								</p>
							</div>
						</div>
						...
						<div className="mb-8 flex justify-center gap-4 items-center w-full right-timeline">
							...
							<div className="order-1 bg-white rounded-lg border border-[#E4E4E6] primaryShadow w-5/12 px-6 py-4">
								...
								<p className="text-sm text-textSecondary">
									...
									establishment of a state-of-the-art oral solid dosage plant,
						...
						<div className="mb-8 flex justify-center gap-4 flex-row-reverse items-center w-full left-timeline">
							...
							<div className="order-1 bg-white rounded-lg border border-[#E4E4E6] primaryShadow w-5/12 px-6 py-4">
								...
								<p className="text-sm text-textSecondary">
									Drug International Limited achieved a breakthrough in 1990 by
									becoming the first company in Bangladesh to formulate
									medicines in soft gelatin capsule form, optimizing absorption
						...
						<div className="mb-8 flex justify-center gap-4 items-center w-full right-timeline">
							...
							<div className="order-1 bg-white rounded-lg border border-[#E4E4E6] primaryShadow w-5/12 px-6 py-4">
								...
								<p className="text-sm text-textSecondary">
									Drug International Limited expanded its global footprint in
									2000 by exporting pharmaceutical products to numerous
						...
						<div className="mb-8 flex justify-center gap-4 flex-row-reverse items-center w-full left-timeline">
							...
							<div className="order-1 bg-white rounded-lg border border-[#E4E4E6] primaryShadow w-5/12 px-6 py-4">
								...
								<p className="text-sm text-textSecondary">
									The adoption of unique supply chain management principles in
									2005 became a hallmark for Drug International Limited,
									ensuring optimized versions of medicines and immediate market
									release.
								</p>
							</div>
						</div>
						...
						<div className="mb-8 flex justify-center gap-4 items-center w-full right-timeline">
							...
							<div className="order-1 bg-white rounded-lg border border-[#E4E4E6] primaryShadow w-5/12 px-6 py-4">
								...
								<p className="text-sm text-textSecondary">
									...
									patient welfare in 2010, aligning formulating principles to
									enhance the quality of life for patients and customers.
								</p>
							</div>
						</div>
						...
						<div className="mb-8 flex justify-center gap-4 flex-row-reverse items-center w-full left-timeline">
							...
							<div className="order-1 bg-white rounded-lg border border-[#E4E4E6] primaryShadow w-5/12 px-6 py-4">
								...
								<p className="text-sm text-textSecondary">
									In 2023, Drug International Limited continues its legacy of
									excellence, utilizing refined production processes to export
									pharmaceutical products worldwide, contributing to the

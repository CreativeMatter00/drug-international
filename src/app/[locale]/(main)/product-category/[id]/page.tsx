						...
						<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-3 gap-y-5 mb-10 md:mb-20">
							{data.specializedP.map((product: any) => (
								<Link
									...
									className="flex items-center justify-center border border-[#e4e4e6] primaryShadow rounded-md w-full transition-all cursor-pointer p-2 hover:border-primary hover:scale-90 min-h-[10rem]"
								>
									<Image

  ...
  return (
    <div className="container mx-auto py-12">
      <p className="text-center pb-12 font-bold text-4xl">
        Privacy Policy of Drug Internation Ltd
      </p>
      <div className="pb-8">
      ...
      <div className="pb-8">
        ...
        <ul className="font-medium ml-8 text-lg">
          <li className="">
          ...
          <li className="">
            ...
            this Agreement) refers to Drug Internation Ltd, Khwaja Enayetpuri
            (R) Tower 17, Bir Uttam K.M. Shafiullah Road (Green Road),
          ...
          <li className="">Country refers to: Bangladesh</li>
          <li className="">
          ...
          <li className="">Service refers to the Website.</li>
          <li className="">
          ...
          <li className="">
            Website refers to Drug Internation Ltd, accessible from{" "}
            <Link href="https://www.drug-international.com/">
              https://www.drug-international.com{" "}
            </Link>
          </li>
          <li className="">

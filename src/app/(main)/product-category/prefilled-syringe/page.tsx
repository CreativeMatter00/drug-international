			...
			<div className="pt-20 mb-4">
				...
				<div className="container mx-auto font-medium">
					...
					<p className="text-textSecondary text-base mb-12">
						Drug International Ltd uses advanced pre-filled syringes for precise
						drug administration. Our high-tech facility meets global standards,
						designed for both local and international demand. Equipped with
						top-notch machinery, the process ensures safety and quality under
						strict guidelines.
					</p>

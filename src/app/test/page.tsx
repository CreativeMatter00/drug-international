...
const Test = () => {
  ...
  return (
    <div className="h-screen bg-gray-500 grid grid-cols-5 gap-4">
      <div className="border border-gray-600 col-span-1"></div>
      <div className="border border-gray-600 col-span-1"></div>
      <div className="border border-gray-600 col-span-1"></div>
      <div className="border border-gray-600 col-span-1"></div>
      <div className="border border-gray-600 col-span-1"></div>

      <div className="border border-gray-600 col-span-5"></div>
